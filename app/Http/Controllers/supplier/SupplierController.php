...
//    supplier Group
    ...
    function addSuppGrp(Request $req)
    {
        ...
        $user->note = $req->note;
        $user->save();
        return redirect('suppGrp-list')->with('message', 'New Supplier Group Created Successfully');
    }
    ...
    function suppGrpDelete(Request $request)
    {
        ...
        return redirect('suppGrp-list')->with('message', 'Supplier Group Deleted Successfully');
    }
    ...
    function suppGrpUpdate(Request $req){
        ...
        $data->note = $req->note;
        $data->save();
        return redirect('suppGrp-list')->with('message','Supplier Group Updated Successfully');
    }
...
//    End supplier Group
    ...
    function addSupplier(Request $req)
    {
        ...
        $user->note = $req->note;
        $user->save();
        return redirect('supplier-list')->with('message', 'New Supplier Created Successfully');
    }
